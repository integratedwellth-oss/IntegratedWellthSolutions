...
const Team = () => {
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* 1. Identity Header */}
      <section id="team" className="pt-40 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* 2. Team Grid with B&W Hover */}
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 justify-center mb-24">
          ...
          {/* 3. RESTORED Mission & Vision Section */}
          <div className="grid lg:grid-cols-3 gap-12 py-20 border-t border-gray-200">
            <RevealOnScroll>
              <div className="flex flex-col items-center text-center p-8 bg-white rounded-3xl shadow-sm hover:shadow-md transition-shadow h-full border border-gray-100">
                <div className="w-16 h-16 bg-brand-50 rounded-2xl flex items-center justify-center text-brand-600 mb-6">
                  <Target size={32} />
                </div>
                <h3 className="text-2xl font-bold text-brand-900 mb-4">Vision Statement</h3>
            ...
            <RevealOnScroll delay={0.2}>
              <div className="flex flex-col items-center text-center p-8 bg-white rounded-3xl shadow-sm hover:shadow-md transition-shadow h-full border border-gray-100">
                ...
                <h3 className="text-2xl font-bold text-brand-900 mb-4">Mission Statement</h3>
                <p className="text-gray-600 leading-relaxed font-medium">
            ...
            <RevealOnScroll delay={0.4}>
              <div className="flex flex-col items-center text-center p-8 bg-white rounded-3xl shadow-sm hover:shadow-md transition-shadow h-full border border-gray-100">
                ...
                <h3 className="text-2xl font-bold text-brand-900 mb-4">Our Core Values</h3>
                <p className="text-gray-600 leading-relaxed font-medium">
