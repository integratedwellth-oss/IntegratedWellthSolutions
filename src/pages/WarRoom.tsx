...
import ComplianceCalendar from '../components/ComplianceCalendar'; // Note the path change
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <header className="flex flex-col md:flex-row justify-between items-center p-6 bg-[#0a0c12] border border-white/5 rounded-2xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-black text-white uppercase tracking-tighter">IWS Tactical Terminal</h1>
            ...
            <section className="bg-[#0a0c12] border border-white/5 rounded-2xl p-8">
              ...
              <div className="mt-12 grid grid-cols-2 gap-6 pt-8 border-t border-white/5">
                <div>
                  ...
                  <span className="text-3xl font-black text-white">{calculations.runway === Infinity ? 'SOVEREIGN' : `${Math.floor(calculations.runway)} Months`}</span>
                </div>
                <div>
