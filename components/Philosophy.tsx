        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2">
            ...
            <RevealOnScroll delay={0.3}>
              <p className="text-lg text-gray-600 mb-6 font-light italic">
            ...
            <RevealOnScroll delay={0.4}>
              ...
              <p className="text-gray-600 mb-6">
                Integrated Wellth Solutions was born to bridge that gap. We don't just fix your books; we equip you with the strategic foresight and emotional resilience to handle wealth.
              </p>
            </RevealOnScroll>
