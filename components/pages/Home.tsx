  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-32 bg-brand-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <RevealOnScroll>
            ...
            <h2 className="text-5xl md:text-7xl font-sora font-extrabold text-white tracking-tighter leading-tight mb-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mt-12">
               <Button 
                ...
                size="lg"
                className="rounded-full px-12 py-8 text-xl bg-brand-gold text-brand-900 font-black uppercase tracking-widest hover:bg-white transition-all shadow-2xl"
               >
                 Execute Audit
               </Button>
               <Button 
                ...
                className="rounded-full px-12 py-8 text-xl border-white/20 text-white hover:bg-white/10"
               >
                 View Ecosystem
               </Button>
            </div>
      ...
      <section className="py-40 bg-white relative flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        <div className="absolute inset-0 opacity-[0.03] bg-brand-900 pointer-events-none" />
        <RevealOnScroll>
          <div className="space-y-12">
            <div className="w-24 h-24 bg-brand-900 rounded-[2.5rem] flex items-center justify-center mx-auto shadow-2xl">
            ...
            <h2 className="text-6xl md:text-8xl lg:text-9xl font-sora font-black text-brand-900 tracking-tighter leading-[0.8]">
              LEGACY <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-900 to-brand-gold italic">SECURED.</span>
            </h2>
            <Button
              onClick={() => window.open('https://calendly.com/enquiries-integratedwellth/30min', '_blank')}
              size="lg"
              className="rounded-full px-16 py-8 text-xl font-black bg-brand-900 shadow-2xl hover:bg-brand-gold hover:text-brand-900 transition-all hover:scale-105"
            >
              CONSULT LEADERSHIP <ArrowRight className="ml-3" />
            </Button>
          </div>
        </RevealOnScroll>
      </section>
