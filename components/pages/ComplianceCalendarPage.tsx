      ...
      <section className="py-20 px-6 max-w-5xl mx-auto space-y-16">
              ...
              <table className="w-full text-left border-collapse shadow-lg rounded-xl overflow-hidden">
                ...
                <tbody className="divide-y divide-gray-200">
                  <tr className="hover:bg-brand-50/50">
                    <td className="p-4 font-mono text-sm border-r border-gray-100">1 &ndash; 245,100</td>
                    <td className="p-4 text-sm">18% of taxable income</td>
                  </tr>
                  <tr className="hover:bg-brand-50/50">
                    <td className="p-4 font-mono text-sm border-r border-gray-100">245,101 &ndash; 383,100</td>
                    <td className="p-4 text-sm">R44,118 + 26% of taxable income above R245,100</td>
                  </tr>
                  <tr className="hover:bg-brand-50/50">
                    <td className="p-4 font-mono text-sm border-r border-gray-100">383,101 &ndash; 530,200</td>
                    <td className="p-4 text-sm">R79,998 + 31% of taxable income above R383,100</td>
                  </tr>
                  <tr className="hover:bg-brand-50/50">
                    <td className="p-4 font-mono text-sm border-r border-gray-100">530,201 &ndash; 695,800</td>
                    <td className="p-4 text-sm">R125,599 + 36% of taxable income above R530,200</td>
                  </tr>
                  <tr className="hover:bg-brand-50/50">
                    <td className="p-4 font-mono text-sm border-r border-gray-100">695,801 &ndash; 887,000</td>
                    <td className="p-4 text-sm">R185,215 + 39% of taxable income above R695,800</td>
                  </tr>
                  <tr className="hover:bg-brand-50/50">
                    <td className="p-4 font-mono text-sm border-r border-gray-100">887,001 &ndash; 1,878,600</td>
        ...
        <RevealOnScroll>
          <div className="bg-white rounded-[2.5rem] p-10 md:p-16 shadow-xl border border-brand-900/10">
            ...
            <div className="space-y-6 text-lg text-brand-900/80 leading-relaxed">
              <p>The core utility of the Compliance Calendar widget lies in its capacity to accurately forecast and alert users to impending statutory deadlines. The user interface must employ a color-coded hierarchy to manage the complex chronology of the 2026 and 2027 tax years.</p>
              
              <h4 className="text-xl font-bold text-brand-900 pt-4 border-t border-brand-900/10 mb-4">High-Frequency Monthly Declarations</h4>
              <table className="w-full text-left border-collapse shadow-md rounded-xl overflow-hidden">
                ...
                <tbody className="divide-y divide-gray-100">
                  <tr className="hover:bg-brand-50/50">
                    ...
                    <td className="p-4 text-sm">EMP201 submission via eFiling</td>
                  </tr>
                  <tr className="hover:bg-brand-50/50">
        ...
        <RevealOnScroll>
          <div className="bg-white rounded-[2.5rem] p-10 md:p-16 shadow-xl border border-brand-900/10">
            ...
            <div className="space-y-6 text-lg text-brand-900/80 leading-relaxed">
              ...
              <table className="w-full text-left border-collapse shadow-lg rounded-xl overflow-hidden">
                ...
                <tbody className="divide-y divide-gray-200">
                  ...
                  <tr className="hover:bg-brand-50/50">
                    ...
                    <td className="p-4 text-sm font-bold text-rose-600">R2,500</td>
                  </tr>
                  <tr className="hover:bg-brand-gold/10">
              ...
              <p className="text-xs text-gray-500 mt-4">Simultaneously, the CIPC requires the mandatory submission of financial records&mdash;referred to as the &quot;Hard-stop&quot; functionality&mdash;on the exact same day the annual return is filed. Depending on the entity&apos;s Public Interest Score, this involves submitting either Audited Financial Statements (AFS), Independently Reviewed Financial Statements, or a Financial Accountability Supplement (FAS).</p>
            </div>
          </div>
        </RevealOnScroll>
