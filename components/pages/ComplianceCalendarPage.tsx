...
import { Calendar, ShieldCheck, AlertTriangle, Clock, Building2, User, Landmark, HelpCircle, ChevronDown, ChevronUp, CheckCircle2, Globe, Zap, ChevronRight } from 'lucide-react';
...
const ComplianceCalendarPage: React.FC = () => {
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="bg-white/5 divide-y divide-white/10 text-sm font-medium">
                    ...
                    <tr className="bg-brand-gold/20">
                      ...
                      <td className="p-4 font-bold text-white">R666,339 + 45% of taxable income above R1,878,600</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="bg-white/5 divide-y divide-white/10 text-sm font-medium">
                    ...
                    <tr className="bg-brand-gold/20">
                      ...
                      <td className="p-4 font-bold text-white">R57,470 + 27% of the amount above R550,000</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-gray-100 text-sm">
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="p-4 font-mono text-rose-600 font-bold">6 February 2026</td>
                      <td className="p-4">EMP201 submission via eFiling / ISV</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="p-4 font-bold text-brand-900">Customs Declarations</td>
                      <td className="p-4 font-mono text-rose-600 font-bold">6 February 2026</td>
                      <td className="p-4">Direct EDI or Customs System</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="p-4 font-bold text-brand-900">VAT Manual Submissions</td>
                      <td className="p-4 font-mono text-rose-600 font-bold">25 February 2026</td>
                      <td className="p-4">Over-the-counter payments</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="p-4 font-bold text-brand-900">Excise Duty Payments</td>
                      <td className="p-4 font-mono text-rose-600 font-bold">26 February 2026</td>
                      <td className="p-4">Electronic Funds Transfer / Branch</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="p-4 font-bold text-brand-900">VAT Electronic Submissions</td>
                      <td className="p-4 font-mono text-rose-600 font-bold">27 February 2026</td>
                      <td className="p-4">Last business day via eFiling</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
  ...
  const CipcProtocols = () => (
    <DetailSection title="Corporate Governance and CIPC Protocols">
      ...
      <div className="pl-6 space-y-3">
        <div className="flex gap-3 items-start"><ChevronRight size={20} className="text-brand-gold shrink-0 mt-0.5" /><p><strong>Private and Public Companies (including external companies):</strong> Must file their annual returns within 30 business days strictly following the anniversary date of their incorporation.</p></div>
        <div className="flex gap-3 items-start"><ChevronRight size={20} className="text-brand-gold shrink-0 mt-0.5" /><p><strong>Close Corporations (CCs):</strong> Must file from the first day of their anniversary month up until the conclusion of the month immediately following.</p></div>
      </div>
  ...
  const LabourStatutoryReporting = () => (
    <DetailSection title="Labour Statutory Reporting: COIDA and Employment Equity">
      ...
      <p>For the 2025/2026 reporting cycle, the widget must display an unyielding deadline of midnight on <strong>Thursday, 15 January 2026</strong>, for the online submission of the EEA2 and EEA4 reports. A critical point of regulatory relief integrated into the system is the redefinition of a "Designated Employer." Entities employing between 1 and 49 employees are no longer classified as designated employers. However, the widget must still prompt these smaller, non-designated entities to log into the EE portal to verify their details. This action is imperative to secure an EE Compliance Certificate—a mandatory prerequisite under Section 53 for accessing state contracts or conducting business with any organ of state.</p>
      ...
      <div className="pl-6 space-y-3 font-bold text-brand-900">
        <div className="flex gap-3 items-start"><span className="text-brand-gold">1.</span><p><strong>Actual Earnings</strong> for the period 1 March 2024 to 28 February 2025, subject to a maximum annual earnings limit of R597,328 per employee.</p></div>
        <div className="flex gap-3 items-start"><span className="text-brand-gold">2.</span><p><strong>Provisional Earnings</strong> for the period 1 March 2025 to 28 February 2026, subject to an elevated annual forecast limit of R633,168 per employee.</p></div>
      </div>
  ...
  return (
    <div className="bg-slate-50 font-sans text-brand-900 selection:bg-brand-gold selection:text-brand-900 pb-20">
      ...
      <section className="py-10 px-6 max-w-5xl mx-auto space-y-16">
        <IntroToRegTech />
        <FiscalAdjustments />
      ...
      {/* 5. FINAL CTA */}
      <section className="py-12 bg-white text-center px-6 rounded-[3rem] max-w-5xl mx-auto shadow-2xl border border-brand-900/10">
        <RevealOnScroll>
