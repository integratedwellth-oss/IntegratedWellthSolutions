...
export const BUSINESS_QUESTIONS: Question[] = [
  ...
  { 
    ...
    question: "How does compliance anxiety and cash flow stress impact your strategic decision-making?", 
    options: [
      { text: "Total financial clarity; compliance is an automated asset, not a burden", score: 4 }, 
      { text: "Moderate stress around tax season and monthly payroll obligations", score: 2 }, 
      { text: "High founder burnout; compliance fear is paralyzing growth", score: 0 }
    ] 
  }
];
