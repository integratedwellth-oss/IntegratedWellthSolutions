  ...
  return (
    <div className="pt-24 pb-20 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <Button variant="outline" onClick={() => window.location.hash = '#home'} className="mb-8 flex items-center gap-2">
        ...
        <article className="prose lg:prose-xl">
          ...
          <img src="https://picsum.photos/800/400?random=3" alt="Tax documents" className="w-full h-64 object-cover rounded-xl mb-8" />
          ...
          <div className="text-center mt-12">
            <Button onClick={() => window.open('https://calendly.com/marcia-kgaphola/new-meeting', '_blank')} size="lg">Book a Tax Compliance Review</Button>
          </div>
        </article>
      </div>
    </div>
